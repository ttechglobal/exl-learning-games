...
// ─────────────────────────────────────────────────────────────────────────────
//  LEARN MISSIONS  (guided — proper change of subject, simple to harder)
// ─────────────────────────────────────────────────────────────────────────────

// M1: Very simple — one step, whole-number coefficients
const LEARN_M1: CosQuestion[] = [
  {
    qLabel: "Make t the subject", formula: "v = t + 5", finalAnswer: "t = v − 5",
    steps: [{
      leftToks: [t("t"), o("+"), t("5", true)], rightToks: [t("v")],
      mascot: "We want <strong>t</strong> alone. <strong>+ 5</strong> is in the way — subtract 5 from both sides.",
      instPrac: "+ 5 is blocking t — subtract 5 from both sides.",
      instChall: "Make t the subject  ·  v = t + 5",
      hint: "The opposite of + 5 is − 5.",
      tileOk: "− 5", tilesNo: ["+ 5", "× 5"],
      whyNot: { "+ 5": "Adding 5 makes it t + 10 — moving further away.", "× 5": "Multiplying doesn't cancel addition." },
      lqT: [t("t + 5 − 5")], lAns: "t", lWrong: ["t + 10", "t − 5"],
      rqT: [t("v − 5")], rAns: "v − 5", rWrong: ["v + 5", "5v"],
      newLeft: [t("t")], newRight: [t("v − 5")],
    }],
  },
  {
    qLabel: "Make m the subject", formula: "F = 3m", finalAnswer: "m = F / 3",
    steps: [{
      leftToks: [t("3m", true)], rightToks: [t("F")],
      mascot: "m is being <strong>multiplied by 3</strong> — divide both sides by 3.",
      instPrac: "m is multiplied by 3 — divide both sides by 3.",
      instChall: "Make m the subject  ·  F = 3m",
      hint: "÷ 3 undoes × 3.",
      tileOk: "÷ 3", tilesNo: ["× 3", "− 3"],
      whyNot: { "× 3": "Multiplying by 3 gives 9m — coefficient grows.", "− 3": "Subtracting 3 gives 3m − 3 — the 3 is still there." },
      lqT: [t("3m ÷ 3")], lAns: "m", lWrong: ["3", "m³"],
      rqT: [t("F ÷ 3")], rAns: "F/3", rWrong: ["3F", "F − 3"],
      newLeft: [t("m")], newRight: [f("F", "3")],
    }],
  },
  {
    qLabel: "Make r the subject", formula: "C = r/2", finalAnswer: "r = 2C",
    steps: [{
      leftToks: [f("r", "2", true)], rightToks: [t("C")],
      mascot: "r is being <strong>divided by 2</strong> — multiply both sides by 2.",
      instPrac: "r is divided by 2 — multiply both sides by 2.",
      instChall: "Make r the subject  ·  C = r/2",
      hint: "× 2 cancels ÷ 2.",
      tileOk: "× 2", tilesNo: ["÷ 2", "+ 2"],
      whyNot: { "÷ 2": "Dividing again gives r/4 — fraction deepens.", "+ 2": "Adding 2 doesn't remove the division." },
      lqT: [f("r","2"), t("× 2")], lAns: "r", lWrong: ["r/4", "2+r"],
      rqT: [t("C × 2")], rAns: "2C", rWrong: ["C/2", "C + 2"],
      newLeft: [t("r")], newRight: [t("2C")],
    }],
  },
  {
    qLabel: "Make n the subject", formula: "S = n − 4", finalAnswer: "n = S + 4",
    steps: [{
      leftToks: [t("n"), o("−"), t("4", true)], rightToks: [t("S")],
      mascot: "<strong>− 4</strong> is blocking n — add 4 to both sides.",
      instPrac: "− 4 is blocking — add 4 to both sides.",
      instChall: "Make n the subject  ·  S = n − 4",
      hint: "The opposite of − 4 is + 4.",
      tileOk: "+ 4", tilesNo: ["− 4", "× 4"],
      whyNot: { "− 4": "Subtracting 4 gives n − 8 — going the wrong way.", "× 4": "Multiplying doesn't cancel subtraction." },
      lqT: [t("n − 4 + 4")], lAns: "n", lWrong: ["n − 8", "n + 4"],
      rqT: [t("S + 4")], rAns: "S + 4", rWrong: ["S − 4", "4S"],
      newLeft: [t("n")], newRight: [t("S + 4")],
    }],
  },
];

// M2: Two-step CoS — the real thing
const LEARN_M2: CosQuestion[] = [
    ...
    steps: [
      {
        ...
        mascot: "We want <strong>t</strong> alone. <strong>u</strong> is in the way — subtract u from both sides.",
        ...
        whyNot: { "+ u": "Adding u makes it larger — moves further away.", "÷ u": "Dividing by u doesn't cancel the u we need to remove." },
      ...
      },
      {
        ...
        mascot: "<strong>t</strong> is multiplied by a — divide both sides by a.",
  ...
  {
    qLabel: "Make w the subject", formula: "P = 2(l + w)", finalAnswer: "w = P/2 − l",
    steps: [
      {
        leftToks: [t("2(l + w)", true)], rightToks: [t("P")],
        mascot: "w is inside brackets <strong>multiplied by 2</strong> — divide both sides by 2.",
        instPrac: "Divide both sides by 2 first to open the bracket.",
        instChall: "Make w the subject  ·  P = 2(l + w)",
      ...
      {
        leftToks: [t("l", true), o("+"), t("w")], rightToks: [f("P", "2")],
        mascot: "<strong>l</strong> is next to w — subtract l from both sides.",
        instPrac: "l is blocking w — subtract l from both sides.",
        instChall: "Make w the subject  ·  P = 2(l + w)",
        hint: "− l cancels the + l.",
        tileOk: "− l", tilesNo: ["+ l", "× l"],
        whyNot: { "+ l": "Adding l makes it l + l + w = 2l + w.", "× l": "Multiplying by l introduces l² unnecessarily." },
        lqT: [t("l + w − l")], lAns: "w", lWrong: ["l+2w", "w−l"],
        rqT: [f("P","2"), t("− l")], rAns: "P/2 − l", rWrong: ["P/2+l", "Pl/2"],
        newLeft: [t("w")], newRight: [f("P","2"), o("−"), t("l")],
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        instPrac: "Divide both sides by π to get r² alone.",
...
// Tier names: learn → challenge → master (progressive difficulty)
// Within each tier, missions go from easier → harder
export const MISSIONS_BY_TIER: Record<string, MissionKey[]> = {
  learn:     ["learn_m1", "learn_m2"],        // 1-step basics → 2-step
  challenge: ["practice_m1", "practice_m2"],  // real formulae → area/volume
  master:    ["challenge_m1", "challenge_m2"], // 3-step complex → physics boss
};

/** Fallback: pick a random mission for the tier */
export function randomMissionForTier(tier: string): CosQuestion[] {
  // Map engine tier names to question bank keys
  const bankTier = tier === "master" ? "master" : tier === "challenge" ? "challenge" : "learn";
  const keys = MISSIONS_BY_TIER[bankTier] ?? MISSIONS_BY_TIER["learn"];
