 ...
 * Extracted from StepwiseSolverEngine.tsx so StepwiseHub and
 * StepwiseMissionComplete can also render her without importing the whole engine.
 */

export function ChideraAvatar({ size = 44 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
